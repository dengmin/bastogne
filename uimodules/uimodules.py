import tornado.web
from config.config import conf, tongji_code
...
class Ad1(tornado.web.UIModule):
    """广告

    """
    def render(self, ad_code):
        return self.render_string('uimodule/ad.html', ad_code=ad_code)
